    ...
    <div>
      ...
      <div className="product_checkout">
        <div className="images">
          <img src="/images/Rectangle56.png" alt="" />
          <img src="/images/Rectangle63.png" alt="" />
          <img src="/images/Rectangle64.png" alt="" />
        </div>
        <div className="product_checkout_content">
          ...
          <p>
            Exercitation sunt consequat et proident cillum reprehenderit eu vest
